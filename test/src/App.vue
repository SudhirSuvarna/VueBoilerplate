...
.container .card-stack .up {
 ...
 .container .card-stack:hover > .buttons.up {
	 display: block;
	 animation: bounceInLeft 200ms;
}
 .container .card-stack:hover > .buttons.down {
	 display: block;
...
[card] {
  ...
  opacity: 0;
  transform: translateX(0) translateY(calc(-100% - 1rem)) scale(1);
